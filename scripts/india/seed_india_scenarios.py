...
SCENARIOS = [
    {
        ...
        "roads": [
            {"name": "NH-7 (Rishikesh-Badrinath Highway)", "blocked": True, "reason": "Debris flow damage near Tapovan",
             "coords": [[79.55, 30.30], [79.62, 30.42], [79.70, 30.48], [79.75, 30.55]]},
            {"name": "Chamoli-Gopeshwar Road", "blocked": False, "reason": None,
             "coords": [[79.30, 30.40], [79.35, 30.41], [79.40, 30.42]]},
            {"name": "Joshimath-Tapovan Link Road", "blocked": True, "reason": "Bridge destroyed by flood surge",
             "coords": [[79.56, 30.55], [79.58, 30.52], [79.62, 30.48]]},
            {"name": "Helang-Pipalkoti Road", "blocked": False, "reason": None,
             "coords": [[79.40, 30.45], [79.45, 30.43], [79.50, 30.40]]},
        ],
    ...
    },
    {
        ...
        "roads": [
            {"name": "Meppadi-Chooralmala Road", "blocked": True, "reason": "Landslide debris covers 200m section",
             "coords": [[76.10, 11.45], [76.12, 11.47], [76.13, 11.49]]},
            {"name": "Kalpetta-Meppadi State Highway", "blocked": True, "reason": "Multiple landslip points",
             "coords": [[76.08, 11.60], [76.10, 11.55], [76.11, 11.50]]},
            {"name": "Wayanad-Kozhikode NH-766", "blocked": False, "reason": None,
             "coords": [[76.04, 11.40], [76.06, 11.45], [76.08, 11.50]]},
            {"name": "Sultan Bathery-Mysore Road", "blocked": False, "reason": None,
             "coords": [[76.23, 11.66], [76.20, 11.60], [76.15, 11.55]]},
        ],
    ...
    },
    {
        ...
        "roads": [
            {"name": "Uttarkashi-Harsil Highway", "blocked": True, "reason": "Landslide + flood debris near Jhala",
             "coords": [[78.44, 30.73], [78.55, 30.85], [78.65, 30.95], [78.73, 31.03]]},
            {"name": "Dharali Village Road", "blocked": True, "reason": "Bridge washout over Jadh Ganga",
             "coords": [[78.73, 31.03], [78.75, 31.04], [78.78, 31.05]]},
            {"name": "Gangotri-Uttarkashi Road", "blocked": False, "reason": None,
             "coords": [[78.90, 30.98], [78.80, 30.90], [78.70, 30.85]]},
        ],
